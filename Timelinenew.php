...
<head>   				
 ...
 http-equiv="content-type" />
  ...
  <style type="text/css" media="screen,projection">
    ...
    */
		.timelineDash{width:1px;overflow:hidden;background:black;height:3px;position:absolute}
		.timelineLabel{overflow:hidden;position:absolute;}
             ...
             <fieldset>
              ...
              <? if ($ma < $sot) echo wikilink($periods[1][$period[1][0]][0]), " era"; else echo "Before formation of Earth.";
					...
					<div id=sources style="text-align:right; font-size:smaller; font-style:italic">
						...
						title="The GEOWHEN database, provided by the international commission for stratigraphy">the GeoWhen database</a>.  Implementation &copy; <a 
						href="http://en.wikipedia.org/wiki/User:Smith609" title="Martin Smith's Wikipedia user page">Martin Smith</a> 2008. <a href='http://en.wikipedia.org/wiki/User_talk:Smith609/Timeline' title="Talk page for this page">Discuss</a>
					</div>
</body>